...
p = 100; % number of components, not including the global intercept
...
switch experiment
    ...
    case 2
        Y = Y+X{2}+3*X{3}+5*X{4}+7*sin(X{5}.^2)+9*exp(-30*(X{6}-0.5).^2)+11*X{7}+13*X{8}+15*X{9}+17*X{10}+19*X{11};
    case 3
        Y = Y+X{2}+3*X{3}+5*X{4}+7*cos(X{5}.^3+pi/2)+9*log(0*X{6}.^2+1)+11*X{7}+13*X{8}+15*X{9}+17*X{10}+19*X{11};
    case 4
        Y = Y+0*X{2}+3*X{3}+0*X{4}+7*cos(X{5}.^2+pi/2)+9*log(0*X{6}.^2+1)+0*X{7}+0*X{8}+0*X{9}+0*X{10}+0*X{11};
end
Y = Y + e;
...
subplot(4,3,1)
plot(A{2},theta_hat{2},'bo','MarkerIndices',1:10:length(theta_hat{2}))
hold on
plot(A{2}, 3*A{2},'r+','MarkerIndices',1:10:length(A{2}))
title('2nd Component')
...
hold on
%plot(A{3}, 5*A{3},'r+','MarkerIndices',1:10:length(A{3}))
...
hold on
%plot(A{4}, 7*A{4},'r+','MarkerIndices',1:10:length(A{4}))
...
%plot(A{5},theta_hat{5},'bo','MarkerIndices',1:10:length(theta_hat{5}))
hold on
%plot(A{5}, 9*A{5},'r+','MarkerIndices',1:10:length(A{5}))
...
subplot(4,3,5)
plot(A{7},theta_hat{7},'bo','MarkerIndices',1:10:length(theta_hat{7}))
hold on
%plot(A{7}, 13*A{7},'r+','MarkerIndices',1:10:length(A{7}))
plot(A{7}, 0*A{7},'r+','MarkerIndices',1:10:length(A{7}))
title('7th Component')
axis([0 1 -1 1])

subplot(4,3,6)
plot(A{9},theta_hat{9},'bo','MarkerIndices',1:10:length(theta_hat{9}))
hold on
%plot(A{9}, 17*A{9},'r+','MarkerIndices',1:10:length(A{9}))
plot(A{9}, 0*A{9},'r+','MarkerIndices',1:10:length(A{9}))
title('9th Component')
axis([0 1 -1 1])

subplot(4,3,7)
plot(A{19},theta_hat{19},'bo','MarkerIndices',1:10:length(theta_hat{19}))
hold on
%plot(A{19}, 37*A{19},'r+','MarkerIndices',1:10:length(A{19}))
plot(A{19}, 0*A{19},'r+','MarkerIndices',1:10:length(A{19}))
title('19th Component')
axis([0 1 -1 1])

subplot(4,3,8)
plot(A{39},theta_hat{39},'bo','MarkerIndices',1:10:length(theta_hat{39}))
hold on
%plot(A{39}, 77*A{39},'r+','MarkerIndices',1:10:length(A{39}))
plot(A{39}, 0*A{39},'r+','MarkerIndices',1:10:length(A{39}))
title('39th Component')
axis([0 1 -1 1])

subplot(4,3,9)
plot(A{59},theta_hat{59},'bo','MarkerIndices',1:10:length(theta_hat{59}))
hold on
%plot(A{59}, 117*A{59},'r+','MarkerIndices',1:10:length(A{59}))
plot(A{59}, 0*A{59},'r+','MarkerIndices',1:10:length(A{59}))
title('59th Component')
axis([0 1 -1 1])

subplot(4,3,10)
plot(A{79},theta_hat{79},'bo','MarkerIndices',1:10:length(theta_hat{79}))
hold on
%plot(A{79}, 157*A{79},'r+','MarkerIndices',1:10:length(A{79}))
plot(A{79}, 0*A{79},'r+','MarkerIndices',1:10:length(A{79}))
title('79th Component')
axis([0 1 -1 1])

subplot(4,3,11)
plot(A{99},theta_hat{99},'bo','MarkerIndices',1:10:length(theta_hat{99}))
hold on
%plot(A{99}, 197*A{99},'r+','MarkerIndices',1:10:length(A{99}))
plot(A{99}, 0*A{99},'r+','MarkerIndices',1:10:length(A{99}))
title('99th Component')
axis([0 1 -1 1])

subplot(4,3,12)
plot(A{100},theta_hat{100},'bo','MarkerIndices',1:10:length(theta_hat{100}))
hold on
%plot(A{100}, 199*A{100},'r+','MarkerIndices',1:10:length(A{100}))
plot(A{100}, 0*A{100},'r+','MarkerIndices',1:10:length(A{100}))
title('100th Component')
axis([0 1 -1 1])
